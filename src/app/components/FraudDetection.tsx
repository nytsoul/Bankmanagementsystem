...
export function FraudDetection() {
  ...
  const fraudRules = [
    { icon: DollarSign, label: 'High-value transactions', description: 'Transactions over $50,000', color: 'text-red-600', bg: 'bg-red-50' },
    { icon: Activity, label: 'Frequent transactions', description: 'More than 5 transactions per hour', color: 'text-orange-600', bg: 'bg-orange-50' },
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl text-gray-800 mb-2">Fraud Detection</h1>
        <p className="text-gray-600">Monitor suspicious transactions</p>
      </div>
        ...
        {fraudRules.map((rule, index) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="text-lg text-gray-800 mb-2">{rule.label}</h3>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl text-gray-800">Flagged Transactions</h2>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-800 mb-1">{customer?.name}</p>
